...
<div><a href='//sketchviz.com/@graveja0/27cb6a8afd59496135e83cd52894349a'><img src='https://sketchviz.com/@graveja0/27cb6a8afd59496135e83cd52894349a/295cccb1b92d82caab9838e779475eaff93e7461.sketchy.png' style='max-width: 200%;'></a><br/><span style='font-size: 80%;color:#555;'>Hosted on <a href='//sketchviz.com/' style='color:#555;'>Sketchviz</a></span></div>
...
We next define a function that takes as its input the parameters. The function does the 
```{r sim_cohort}
...
3. Specify the cycle-specific adjustment factors for the model. 
