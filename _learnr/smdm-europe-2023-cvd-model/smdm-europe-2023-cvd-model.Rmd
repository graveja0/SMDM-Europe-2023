...
The code below draws on the "superassignment" operator `<<-` which will continuously update the trace (`tr`) with the last value calculated. 
...
life_exp_markov <- 
  cycle_adj(tr %*% params$payoff_qaly, 1)
