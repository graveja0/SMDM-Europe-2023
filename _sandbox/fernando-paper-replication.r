# https://arxiv.org/pdf/2108.13552.pdf 
# https://journals.sagepub.com/doi/10.1177/0272989X05280562?url_ver=Z39.88-2003&rfr_id=ori:rid:crossref.org&rfr_dat=cr_pub%20%200pubmed 

source(here::here("slides/manifest.r"))
source(here::here("_sandbox/darth-functions.R"))
...
lt_usa_2015 <- read.csv(here::here("_sandbox/LifeTable_USA_Mx_2015.csv"))
