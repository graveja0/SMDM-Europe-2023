...
If $\epsilon_M - \epsilon_{ref} \sim 0$ the impact to the decision threshold is
minimal. 
    
-   These decision thresholds are semi-*robust* against this misspecification.
-   Restated: Single model runs are biased under misspecification, but decision
threshold comparisons cancel this out. 

## Rate Misspecification Conclusions

-   Existing publications decision thresholds are generally okay if they
misspecified rates under 3a.
